...
declare -A theme_attr_dict=(
    ["global-frame_color"]="\"$(xrdb_get 'color10' '#555555')\""

    ["urgency_low-background"]="\"$(xrdb_get 'color0' '#2b303b')\""
    ["urgency_low-foreground"]="\"$(xrdb_get 'color3' '#65737e')\""

    ["urgency_normal-background"]="\"$(xrdb_get 'color0' '#2b303b')\""
    ["urgency_normal-foreground"]="\"$(xrdb_get 'color3' '#a3be8c')\""

    ["urgency_critical-background"]="\"$(xrdb_get 'color0' '#2b303b')\""
    ["urgency_critical-foreground"]="\"$(xrdb_get 'color3' '#bf616a')\""
)
...
readonly user_conf="$user_conf_dir/dunstrc_xcolors"
